...
int
_minifyjpeg_proc_1 (image_t  *argp, void *result, struct svc_req *rqstp)
{
...
{
	union {
		image_t minifyjpeg_proc_1_arg;
	} argument;
	union {
		image_t minifyjpeg_proc_1_res;
	} result;
	bool_t retval;
	...
	case MINIFYJPEG_PROC:
		_xdr_argument = (xdrproc_t) xdr_image_t;
		_xdr_result = (xdrproc_t) xdr_image_t;
